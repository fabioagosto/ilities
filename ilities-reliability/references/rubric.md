# ilities Rubric: Robustness & Reliability lens

The slice of the ilities rubric this skill needs: the **intent gate** (run
first, every time), the **scoring scale**, the **Robustness & Reliability** dimension, and
...
## The Robustness & Reliability dimension
