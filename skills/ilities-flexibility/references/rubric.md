# ilities Rubric: Flexibility & Extensibility lens

The slice of the ilities rubric this skill needs: the **intent gate** (run
first, every time), the **scoring scale**, the **Flexibility & Extensibility** dimension, and
...
## The Flexibility & Extensibility dimension
